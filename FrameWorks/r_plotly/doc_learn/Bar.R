...
p1 = plot_ly(data = data, 
             x = ~ Animals, 
             y = ~ SF_Zoo, name = 'SF Zoo', 
             type = 'bar')
p1
...
p2 = plot_ly(data = data, 
             x = ~ Animals) %>%
    add_bars(y = ~ SF_Zoo, name = 'SF Zoo')
p2
#========================================================
#                 Basic Horizontal Bar Chart
#========================================================
p3 = plot_ly(data = data, 
             x = ~ SF_Zoo, 
             y = ~ Animals, name = 'SF Zoo', 
             type = 'bar', 
             orientation = 'v')
p3
...
p4 = plot_ly(data = data,
             x = ~ SF_Zoo,
             orientation = 'h') %>%
    add_bars(y = ~ Animals, name = 'SF Zoo')
p4

# or

p5 = plot_ly(data = data,
             x = ~ SF_Zoo) %>%
    add_bars(y = ~ Animals, name = 'SF Zoo',
             orientation = 'h')
p5
...
p7 = plot_ly(data = data,
             x = ~ Animals, 
             y = ~ SF_Zoo, name = 'SF Zoo',
             type = 'bar') %>%
    add_bars(y = ~ LA_Zoo, name = 'LA Zoo') %>%   # add_bars()
    layout(yaxis = list(title = 'Count'),
           barmode = 'group')
p7

p8 = plot_ly(data = data,
             x = ~ Animals) %>%
    add_bars(y = ~ SF_Zoo, name = 'SF Zoo') %>%   # add_bars()
    add_bars(y = ~ LA_Zoo, name = 'LA Zoo') %>%   # add_bars()
    layout(yaxis = list(title = 'Count'),
           barmode = 'group')
p8
...
#                 Stacked Bar Chart
#========================================================
p9 = plot_ly(data = data,
             x = ~ Animals) %>%
    add_bars(y = ~ SF_Zoo, name = 'SF Zoo') %>%
    add_bars(y = ~ LA_Zoo, name = 'LA Zoo') %>%
    layout(barmode = 'stack',
           yaxis = list(title = 'Count'))
p9

p9 = plot_ly(data = data,
             x = ~ Animals, y = ~ SF_Zoo, name = 'SF Zoo', 
             type = 'bar') %>%
    add_trace(y = ~ LA_Zoo, name = 'LA Zoo') %>%
    layout(barmode = 'stack',
           yaxis = list(title = 'Count'))
...
p9 = plot_ly(data = data,
             x = ~ SF_Zoo, y = ~ Animals, name = 'SF Zoo', 
             type = 'bar',
             orientation = 'h') %>%
...
#========================================================
p10 = plot_ly(data = data, 
             x = ~ SF_Zoo, name = 'SF Zoo', y = ~ Animals, 
             type = 'bar', 
             orientation = 'h',
...
x_saving = c(1.3586, 
             ...
             15.2148, 
             17.520499999999998)
x_net_worth = c(93453.919999999998, 
                81666.570000000007, 
                69889.619999999995, 
                78381.529999999999, 
                141395.29999999999, 
...
p1 = plot_ly(x = ~x_saving, y = ~reorder(y, x_saving), 
...
p2 = plot_ly(x = ~x_net_worth, y = ~reorder(y, x_saving), 
